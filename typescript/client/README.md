...
lifecycle shell, a managed subscription handle primitive, and typed runtime
interfaces. It does not implement reducer/query/view protocol messages,
reconnect policy, reducer argument encoding, row decoding, or cache behavior
yet.
...
WebSocket factory for Node tests or host-specific transports.
