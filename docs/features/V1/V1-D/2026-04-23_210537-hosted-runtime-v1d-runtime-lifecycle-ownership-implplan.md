...
- broad tests pass, or unrelated dirty-state failures are reported without fixing query/protocol code inside V1-D
...
V1-D plan as a live handoff; use the relevant feature plan for
