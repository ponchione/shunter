...
- `docs/decomposition/hosted-runtime-version-phases.md` defines V1-E as runtime network surface:
...
Files:
- Read: V1-A through V1-D implplans under `docs/hosted-runtime-planning/`
