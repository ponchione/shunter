...
- `docs/decomposition/hosted-runtime-version-phases.md` defines the V1-B target surface as:
  - `Module.SchemaVersion(...)`
  - `Module.TableDef(...)`
  - `Module.Reducer(...)`
  - `Module.OnConnect(...)`
  - `Module.OnDisconnect(...)`
- `docs/decomposition/hosted-runtime-v1-contract.md` keeps v1 module authoring explicit and imperative first.
