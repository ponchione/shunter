...
| --- | --- | --- |
| Go quality | tracked Go formatting, module tidiness, vet, pinned Staticcheck, whitespace | `rtk go fmt <touched files>`, `rtk go mod tidy -diff`, `rtk go vet ./...`, `rtk go tool staticcheck ./...`, `rtk git diff --check` |
