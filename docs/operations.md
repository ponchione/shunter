...
4. Build release binaries with linker variables:
...
5. Tag released versions with `vX.Y.Z`.
6. Keep normal post-release development on a `-dev` version unless cutting a
   release.
