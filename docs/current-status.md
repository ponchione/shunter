...
- protocol connection lifecycle races and unsafe channel-close behavior (`watchReducerResponse` goroutine-leak sub-hazard closed 2026-04-20, see `docs/hardening-oi-004-watch-reducer-response-lifecycle.md`; `connManagerSender.enqueueOnConn` overflow-disconnect background-ctx sub-hazard closed 2026-04-21, see `docs/hardening-oi-004-sender-disconnect-context.md`; `superviseLifecycle` disconnect-ctx sub-hazard closed 2026-04-21, see `docs/hardening-oi-004-supervise-disconnect-context.md`; broader `conn.go` / `lifecycle.go` / `outbound.go` / `keepalive.go` lifecycle concerns remain open)
- snapshot / read-view lifetime hazards (iterator-GC retention sub-hazard closed 2026-04-20, see `docs/hardening-oi-005-snapshot-iter-retention.md`; iterator use-after-Close sub-hazard closed 2026-04-20, see `docs/hardening-oi-005-snapshot-iter-useafterclose.md`; iterator mid-iter-close defense-in-depth sub-hazard closed 2026-04-20, see `docs/hardening-oi-005-snapshot-iter-mid-iter-close.md`; subscription-seam read-view lifetime sub-hazard closed 2026-04-20, see `docs/hardening-oi-005-subscription-seam-read-view-lifetime.md`; `CommittedSnapshot.IndexSeek` BTree-alias escape closed 2026-04-20, see `docs/hardening-oi-005-committed-snapshot-indexseek-aliasing.md`; `StateView.SeekIndex` BTree-alias escape closed 2026-04-20, see `docs/hardening-oi-005-state-view-seekindex-aliasing.md`; `StateView.SeekIndexRange` BTree-alias escape closed 2026-04-20, see `docs/hardening-oi-005-state-view-seekindexrange-aliasing.md`; broader `state_view.go` / `committed_state.go` lifetime concerns remain open)
