...
[ for each table:
    ...
    // MUST emit 0, and v1 readers MUST reject any snapshot where a column has
    // `nullable = 1` (see SPEC-006 §2.2 / §9 — `ErrNullableColumn` in SPEC-006 §13).
