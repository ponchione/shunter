...
func TestGeneratorAcceptsCanonicalContractJSON(t *testing.T) {
	...
	assertContains(t, ts, `export type DeclaredViewSubscriptionOptions<Row = unknown> = ShunterDeclaredViewSubscriptionOptions<Row>;`)
	...
	assertContains(t, ts, `callReducerWithEncodedArgs as shunterCallReducerWithEncodedArgs,`)
