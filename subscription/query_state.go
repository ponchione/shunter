...
func (r *queryRegistry) createQueryState(hash QueryHash, pred Predicate, projection []ProjectionColumn, aggregate *Aggregate, orderBy []OrderByColumn, limit *uint64) *queryState {
