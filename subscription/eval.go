...
func (m *Manager) collectCandidatesInto(cs *store.Changeset, view store.CommittedReadView, st *candidateScratch) map[QueryHash]struct{} {
	...
	for tid, tc := range cs.Tables {
		...
		collectJoinPathEdgeCandidates(m.indexes, tid, tc.Inserts, view, m.resolver, addJoinCandidate)
		collectJoinPathEdgeCandidates(m.indexes, tid, tc.Deletes, view, m.resolver, addJoinCandidate)
		collectJoinPathFilterDeltaCandidates(m.indexes, tid, tc.Inserts, cs, view, m.resolver, addJoinCandidate)
		collectJoinPathFilterDeltaCandidates(m.indexes, tid, tc.Deletes, cs, view, m.resolver, addJoinCandidate)
		collectJoinPath3EdgeCandidates(m.indexes, tid, tc.Inserts, view, m.resolver, addJoinCandidate)
		collectJoinPath3EdgeCandidates(m.indexes, tid, tc.Deletes, view, m.resolver, addJoinCandidate)
		collectJoinPath3FilterDeltaCandidates(m.indexes, tid, tc.Inserts, cs, view, m.resolver, addJoinCandidate)
		collectJoinPath3FilterDeltaCandidates(m.indexes, tid, tc.Deletes, cs, view, m.resolver, addJoinCandidate)
		collectJoinPath4EdgeCandidates(m.indexes, tid, tc.Inserts, view, m.resolver, addJoinCandidate)
		collectJoinPath4EdgeCandidates(m.indexes, tid, tc.Deletes, view, m.resolver, addJoinCandidate)
		collectJoinPath4FilterDeltaCandidates(m.indexes, tid, tc.Inserts, cs, view, m.resolver, addJoinCandidate)
		collectJoinPath4FilterDeltaCandidates(m.indexes, tid, tc.Deletes, cs, view, m.resolver, addJoinCandidate)
		collectJoinPath5EdgeCandidates(m.indexes, tid, tc.Inserts, view, m.resolver, addJoinCandidate)
		...
		collectJoinPath7EdgeCandidates(m.indexes, tid, tc.Inserts, view, m.resolver, addJoinCandidate)
		collectJoinPath7EdgeCandidates(m.indexes, tid, tc.Deletes, view, m.resolver, addJoinCandidate)
		collectJoinPath7FilterDeltaCandidates(m.indexes, tid, tc.Inserts, cs, view, m.resolver, addJoinCandidate)
		collectJoinPath7FilterDeltaCandidates(m.indexes, tid, tc.Deletes, cs, view, m.resolver, addJoinCandidate)
		collectJoinPath8EdgeCandidates(m.indexes, tid, tc.Inserts, view, m.resolver, addJoinCandidate)
		collectJoinPath8EdgeCandidates(m.indexes, tid, tc.Deletes, view, m.resolver, addJoinCandidate)
		collectJoinPath8FilterDeltaCandidates(m.indexes, tid, tc.Inserts, cs, view, m.resolver, addJoinCandidate)
		collectJoinPath8FilterDeltaCandidates(m.indexes, tid, tc.Deletes, cs, view, m.resolver, addJoinCandidate)
